...
recursive or not.
-}
unconstrained :: forall symbol constraint. (Typeable symbol, Constraint constraint) => Node symbol constraint -> Bool
unconstrained = memoTypeableWith @symbol @constraint unconstrainedCache $ getAll . crush free
  where
