...
-}
module Data.ECTA.Gen.Internal.Chain (
    -- * Chains
    ArgMaps (..),
    ArgChain (..),
    ArgStatics,
...
selectChain ::
    ...
    [Term Symbol] ->
    Integer ->
    Either ECTAGenError ([Term Symbol], [Term InspectionSymbol], Rational, result)
...
selectChain _ (ChainCons _ _) [] _ =
    error
        "microecta-generator bug in Data.ECTA.Gen.Internal.Chain.selectChain: \
