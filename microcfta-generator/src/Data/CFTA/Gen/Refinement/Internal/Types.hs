...
-}
module Data.CFTA.Gen.Refinement.Internal.Types (
...
finiteFromList values =
    case Ranked.fromWeighted [(1, value) | value <- values] of
        ...
        Left err -> error $ "microcfta-generator bug in Data.CFTA.Gen.Refinement.Internal.Types.finiteFromList: " <> show err
    ...
    case [ranked | RankedFinite ranked <- alternatives] of
        ...
        rankedAlternatives ->
            case Ranked.oneof rankedAlternatives of
                Right ranked -> RankedFinite ranked
                Left err -> error $ "microcfta-generator bug in Data.CFTA.Gen.Refinement.Internal.Types.finiteOneof: " <> show err
...
preparedGenerator generator =
    case generatorPrepared generator of
        ...
        Nothing -> error "microcfta-generator bug in Data.CFTA.Gen.Refinement.Internal.Types: source used before preparation"
