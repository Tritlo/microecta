                ...
                let guard =
                    ...
                    term =
                        Tree.Node
                            ...
                            [ Tree.Node (LiquidSymbol "x" (variable "v" .== 0)) []
                            , Tree.Node (LiquidSymbol "y" (variable "v" .== 1)) []
                            ]
                evaluateGuard solver guard term >>= (`shouldBe` No)
                ...
                let guard requirement =
                    ...
                    term =
                        Tree.Node
                            ...
                            , Tree.Node (LiquidSymbol "y" true) []
                            , Tree.Node (LiquidSymbol "w" (variable "v" .== 1)) []
                            , Tree.Node (LiquidSymbol "z" true) []
                            ]
...
collidingActuals =
    Tree.Node
        ...
        [ Tree.Node (LiquidSymbol "app" (variable "v" .== 0)) [Tree.Node (LiquidSymbol "zero" true) []]
        , Tree.Node (LiquidSymbol "app" (variable "v" .== 1)) [Tree.Node (LiquidSymbol "one" true) []]
        , Tree.Node (LiquidSymbol "x" true) []
        , Tree.Node (LiquidSymbol "y" true) []
        ]
