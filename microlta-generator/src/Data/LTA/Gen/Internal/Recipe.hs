...
-}
module Data.LTA.Gen.Internal.Recipe (
    validateGenerator,
    childRecipeArity,
    rawRecipeCount,
    knownEmptyRecipe,
...
rawRecipeCount (AutomatonRecipe _ _) = error "microlta-generator bug in Data.LTA.Gen.Internal.Recipe.rawRecipeCount: an automaton source was not prepared"
