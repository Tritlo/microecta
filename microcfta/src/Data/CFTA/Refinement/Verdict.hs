...
newtype Entailment = ScopedEntailment
    { entailsWithBindings :: [(Fixpoint.Symbol, Fixpoint.Symbol)] -> Formula -> Formula -> IO Verdict
...
-}
pattern Entailment :: (Formula -> Formula -> IO Verdict) -> Entailment
...
-}
refinementRelation :: Entailment -> Formula -> Formula -> IO RefinementRelation
...
or a symmetric meet.
-}
semanticIntersection :: Entailment -> Formula -> Formula -> IO SemanticIntersection
