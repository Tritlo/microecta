...
import Data.CFTA.Refinement.Types (Formula, LiquidSymbol (LiquidSymbol))
...
pattern Transition :: Symbol -> Formula -> [Automaton] -> LiquidConstraint -> Transition
...
transitionRefinement :: Transition -> Formula
