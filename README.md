...
The original ECTA line stays in this repository as
[`microecta`](microecta/README.md) and
[`microecta-generator`](microecta-generator/README.md). `microecta` remains on
Hackage as a separate, ECTA-only package.
