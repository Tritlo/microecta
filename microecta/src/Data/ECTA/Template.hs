...
The patterns come from "Data.Tree.FTA.Template". 'termsMatching' restricts
...
import Data.ECTA.Internal.ECTA.Type (Node, fromInterned, toInterned)
import Data.Tree.FTA.Template (Template (..), matchesTemplate, restrict)
