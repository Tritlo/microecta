...
This is example code. It is exposed so the LTA benchmarks can compare against
it, and it is not a stable interface.
...
import Data.CFTA.Gen.Equality.QuickCheck (ECTAGen, Grouped, Sig ((:*), (:->)))
